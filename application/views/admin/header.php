...
<body>
	<nav id="nav-relawan" class="navbar navbar-default" style="margin-bottom:0px">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li><a href="<?= base_url('admin/peta') ?>">Peta Sungai</a></li>
					<li><a href="<?= base_url('admin/relawan') ?>">Relawan</a></li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
					<li><a href="<?= base_url('auth/logout_admin') ?>"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
				</ul>
			</div>
		</div>
	</nav>	